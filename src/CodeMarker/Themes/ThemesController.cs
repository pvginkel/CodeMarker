...
namespace CodeMarker.Themes
{
    public static class ThemesController
    {
        ...
        public static void SetTheme(ThemeType theme)
        {
            ...
            {
                Source = new Uri(
                    $"pack://application:,,,/CodeMarker;component/Themes/ColourDictionaries/{themeName}.xaml"
                )
            };
            ControlColours = new ResourceDictionary()
            {
                Source = new Uri(
                    "pack://application:,,,/CodeMarker;component/Themes/ControlColours.xaml"
                )
            };
            RefreshControls();
        }
